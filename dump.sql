...
--
-- Host: db
-- Tempo de geração: 20/05/2021 às 16:38
...
CREATE TABLE `cliente` (
  `id` int NOT NULL,
  `cpf_ou_cnpj` varchar(255) CHARACTER SET utf8  DEFAULT NULL,
...
(1, '12313123', 'maria@gmail.com', 'Maria Silva', 1);
...
(1, 'Jardim', '32323232', 'Apto 203', 'Rua Flores', '300', 1, 1),
(2, 'Centro', '32323232', 'sala 800', 'Avenida Matos', '105', 2, 1);
...
(2, '2017-10-10 10:32:00.000000', 1, 2);
...
CREATE TABLE `telefone` (
  ...
  `telefones` varchar(255) CHARACTER SET utf8  DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ;
